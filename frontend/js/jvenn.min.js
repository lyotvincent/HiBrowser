	...
	a.fn.jvenn = function(b) {
		...
		function B(b, c) {
			...
			a("*[id^=" + N + "-label]").each(function() {
				...
				g += '<span style="background-color:white; margin-left:-1px; padding:0px 2px 0px 2px; transition: margin-left .3s ease-in-out;">off</span></div>',
				e += 1,
				e > c && (f = ";display:none")
			}),
			g += "</div>",
		...
		function J(b, c, d) {
			...
			h += '<div id="' + N + '-format-png" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download PNG</div>',
			h += '<div id="' + N + '-format-svg" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download SVG</div>',
			"list" == d && (h += '<div id="' + N + '-format-csv" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download CSV</div>'),
			h += "</div>",
			h += "</div>",
			h += "</div>",
			$t.append(h);
		...
		function K(b, c) {
			...
			legend_button.children("span").css("margin-left", "-1px"),
		...
		return this.each(function() {
			...
			a("<style>.module-legend{border:1px solid lightgrey;border-radius:5px;position:relative;left:" + h + "px;top:-" + (i + c) + "px;width:40px;padding-bottom:3px}</style>").appendTo("body"),
			a("<style>.leg-items{padding-top:1px;margin:3px 3px 0px 3px;cursor:pointer;border: 1px solid grey;border-radius:2px;width:30px;height:11px;font-size:0.65em;line-height:10px;opacity:0.75}</style>").appendTo("body");
